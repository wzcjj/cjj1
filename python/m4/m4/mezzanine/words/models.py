...
class WordsPost(Displayable, Ownable, RichText, AdminThumbMixin):
    """
    A blog post.
    """

    categories = models.ManyToManyField("WordsCategory",
    ...
    featured_image = FileField(verbose_name=_("Featured Image"),
        upload_to=upload_to("words.WordsPost.featured_image", "blog"),
