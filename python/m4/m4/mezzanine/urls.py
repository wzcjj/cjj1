...
# My words app.
words_installed = "mezzanine.words" in settings.INSTALLED_APPS
if words_installed:
    WORDS_SLUG = settings.WORDS_SLUG.rstrip("/")
    words_patterns = patterns("",
        ("^%s" % WORDS_SLUG, include("mezzanine.words.urls")),
    )
    urlpatterns += words_patterns
