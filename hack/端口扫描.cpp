...
int portip, hoststart, hoststop, startport, endport;  //开始I和结束P地址，开始和结束端口
long searchnum, searched;
void usage(char *);    // 显示使用方法函数
void playx(int);    // 状态提示函数
void setip2(char *);   // 设置IP函数
void customport(char *, char *, char *); // 自扫描端口函数
void portscannow(int);   // 端口扫描扫描
// 主程序
